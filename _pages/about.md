...
- **The Effect of Maternity Leave Policies on Local Labor Market Outcomes**  
  *with Karla Hernández*
  ...
  <span class="abstract-toggle"
        onclick="this.nextElementSibling.style.display = (this.nextElementSibling.style.display === 'block' ? 'none' : 'block'); this.classList.toggle('open');"
        style="cursor:pointer; color:#0072B2; font-size:0.9rem; margin-left:0.3rem;">
    <i class="fa fa-chevron-down"></i>
  </span>

  <div style="display:none; margin-top:0.6rem;" markdown="1">
