...
</a></strong> <span style="cursor:pointer; color:#0072B2; text-decoration:underline; margin-left:0.4rem;"
      onclick="this.nextElementSibling.style.display = (this.nextElementSibling.style.display === 'block' ? 'none' : 'block');">[Abstract]</span>
<div style="display:none; margin-top:0.5rem;" markdown="1">
...
<span style="cursor:pointer; color:#0072B2; text-decoration:underline; margin-left:0.4rem;"
      onclick="this.nextElementSibling.style.display = (this.nextElementSibling.style.display === 'block' ? 'none' : 'block');">[Abstract]</span>
