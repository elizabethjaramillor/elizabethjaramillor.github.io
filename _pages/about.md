...
<strong><a href="#" target="_blank" rel="noopener">The Effect of Maternity Leave Policies on Local Labor Market Outcomes</a></strong> (with <a href="https://www.karla-hernandez.com" target="_blank" rel="noopener">Karla Hernandez</a>) <details style="display:inline;"><summary style="display:inline; cursor:pointer; color:#0072B2; text-decoration:underline; margin-left:0.4rem;">[Abstract]</summary><div style="margin-top:0.5rem;" markdown="1">
